...
int main()
{
    ...
    p[0].at=4;p[1].at=2;p[2].at=3;p[3].at=0;p[4].at=1;
    p[0].bt=7;p[1].bt=3;p[2].bt=5;p[3].bt=12;p[4].bt=6;
    for(int i=0;i<n;i++)
    p[i].st=-1;   
    ...
    for(int i=0;i<n;i++)
    {
        cout<<p[i].id<<"\t"<<p[i].at<<"\t"<<p[i].bt<<"\t"<<p[i].st<<"\t"<<p[i].ct<<"\t"<<p[i].rt<<"\t"<<p[i].tat<<"\t"<<p[i].wt<<endl;
    }
